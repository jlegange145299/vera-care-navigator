        ...
        <div className="demo-guide-backdrop" onMouseDown={() => setOpen(false)}>
          <aside className="demo-guide" role="dialog" aria-modal="true" aria-labelledby="demo-guide-title" onMouseDown={(event) => event.stopPropagation()}>
            ...
            <ol className="walkthrough-steps">
              <li><span>01</span><div><strong>Ask with your voice</strong><p>Choose “Lower my medication cost” or say it naturally. Watch Vera listen, reason, and respond.</p><button type="button" onClick={() => { onNavigate("member"); setOpen(false); }}><MessageCircle size={14} /> Open member experience</button></div></li>
              ...
              <li><span>03</span><div><strong>Reveal the learning system</strong><p>Open Friction Intelligence to show value, journey barriers, inclusive access, and privacy-preserving signals.</p><button type="button" onClick={() => { onNavigate("insights"); setOpen(false); }}><ChartNoAxesCombined size={14} /> Open business insights</button></div></li>
            </ol>
