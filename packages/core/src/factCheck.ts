import type { FactCheckResult, FactCheckSource, FactCheckVerdict } from "./types.js";
...
export const factCheckPrompt = {
  shortLabel: "Check a health claim",
  prompt: "Is it true that antibiotics treat the common cold?",
};
